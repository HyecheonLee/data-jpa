...
class MemberTest {
    ...
    void testEntity() {
        ...
        final var member1 = new Member("member1", 10, teamA);
        final var member2 = new Member("member2", 20, teamA);
        final var member3 = new Member("member3", 30, teamA);
        final var member4 = new Member("member4", 40, teamA);
